...
function setLine(contentid, value, interval, line_name, v_max, v_min, v_unitInterval, times, v_unitInterval_time, timeX1, timeX2, timeX3, value2, timeduan, daypre, daynow) {
    ///<summary>绘制时间段折线图的方法</summary>
    ///<param name="contentid" type="String">折线图呈现标签</param>
    ///<param name="value" type="String">处理后的json数据</param>
    ...
    ///<param name="value2" type="String">处理前的json数据（备用）</param>
